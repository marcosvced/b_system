        ...
        initSwiper: () => {
            ...
            swiperList.forEach((swiper) => {
                ...
                if (slidesPerViewSm || slidesPerViewMd || slidesPerViewLg || slidesPerViewXl || slidesPerViewXxl) {
                    if (slidesPerViewSm) {
                        config.breakpoints = {...config.breakpoints, [breakpointList.sm]: {slidesPerView: slidesPerViewSm}}
                    }
                    if (slidesPerViewMd) {
                        config.breakpoints = {...config.breakpoints, [breakpointList.md]: {slidesPerView: slidesPerViewMd}}
                    }
                    if (slidesPerViewLg) {
                        config.breakpoints = {...config.breakpoints, [breakpointList.lg]: {slidesPerView: slidesPerViewLg}}
                    }
                    if (slidesPerViewXl) {
                        config.breakpoints = {...config.breakpoints, [breakpointList.xl]: {slidesPerView: slidesPerViewXl}}
                    }
                    if (slidesPerViewXxl) {
                        config.breakpoints = {...config.breakpoints, [breakpointList.xxl]: {slidesPerView: slidesPerViewXxl}}
                    }
                }
