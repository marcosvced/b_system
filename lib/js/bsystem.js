...
const system = {
    ...
    headerHeight:() => {
        const header = document.querySelector('body > .header-wrapper') ?? document.querySelector('body > header')
        const onResize = () => {
            const body = document.querySelector("body")
            body.style = `--hb-height:${header.clientHeight}px`;
        }
        onResize()
...
const b_system = (() => {
    ...
    window.addEventListener('load', () => setTimeout(() => system.setBodyTopSpace()), {passive: true})
