...
const bsystem = (() => {
  ...
  function setBodyPadding() {
    const headerLight = selector.find(`.header-light${DATA_ATTR.STICKY}`)
    console.log('head -> ', headerLight)
    if (!headerLight) {
      return
    }
    selector.find('body').style.cssText = `--head: ${headerLight.clientHeight}px;`
  }
